...
$routes->group('admin', ['filter' => 'checkAdmin'], function ($routes) {
    ...
    $routes->get('hapus-kriteria/(:num)', 'Admin\Kriteria::hapusKriteria/$1');
    ...
    $routes->get('hapus-sub-kriteria/(:num)', 'Admin\SubKriteria::hapusSubKriteria/$1');
    ...
    $routes->get('hapus-lapangan/(:num)', 'Admin\Lapangan::hapusLapangan/$1');
    ...
    $routes->get('hapus-ulasan/(:num)', 'Admin\InformasiKontak::hapusUlasan/$1');
    ...
    $routes->get('hapus-user/(:num)', 'Admin\User::hapusUser/$1');
