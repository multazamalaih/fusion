            ...
            <div class="lapangan-item">
                ...
                <div class="d-flex border-top">
                    <small class="w-50 text-center border-end py-2">
                        <a class="text-body" href="/detail-lapangan/<?= $data[0]['id_lapangan'] ?>"><i class="fa fa-eye text-primary me-2"></i>Lihat Detail</a>
                    </small>
                    <small class="w-50 text-center py-2">
                        <a class="text-body" target="_blank" href="https://wa.me/<?= $data[0]['no_hp'] ?>"><i class="fab fa-whatsapp text-primary me-2 fa-lg"></i>Pesan</a>
                    </small>
                </div>
            </div>
        </div>
...
<div class="container mb-5 wow fadeInUp" data-wow-delay="0.1s">
    <div class="scroll-hasil-wrapper">
        <table class="table table-bordered scroll-hasil-table text-center align-middle">
            <thead class="table-costum text-center">
                <tr>
                    <th style="letter-spacing: 2px;">Rank</th>
            ...
            <tbody class="text-center">
                ...
                <?php foreach ($data as $hasil) : ?>
                    <tr>
                        ...
                        <td><?= $hasil['nama'] ?></td>
                        <td><?= $hasil['nilai'] ?></td>
                        <td><a href="/detail-lapangan/<?= $hasil['id_lapangan'] ?>" class="btn btn-sm btn-secondary rounded-pill px-3"> Lihat Detail</a></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
...
<div class="container text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">
    <a href="cetak-rekomendasi.php" target="_blank" class="btn btn-primary rounded-pill py-3 px-5" style="letter-spacing: 8px;"><i class="fa fa-print me-2"></i>CETAK DATA</a>
</div>
