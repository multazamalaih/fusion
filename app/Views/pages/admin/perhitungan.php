...
<?php if (isset($penilaianLengkap) && $penilaianLengkap && session()->getFlashdata('successperhitungan')): ?>
	<div class="alert alert-success alert-dismissible fade show" role="alert">
		<button type="button" class="close" data-dismiss="alert">&times;</button>
		<?= session()->getFlashdata('successperhitungan') ?>
	</div>
<?php endif; ?>
<?php if (session()->getFlashdata('errorperhitungan')): ?>
	<div class="alert alert-danger alert-dismissible fade show" role="alert">
		<?= session()->getFlashdata('errorperhitungan') ?>
	</div>
	<?php session()->remove('success'); ?>
<?php endif; ?>


<?php if (isset($penilaianLengkap) && $penilaianLengkap): ?>
	<!-- Matriks Keputusan (X) -->
